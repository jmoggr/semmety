...
public:
	...
	public:
		...
		bool operator==(const Window& other) const { return window.get() == other.window.get(); }
	};
	...
	public:
		...
		Parent(
		    SP<SemmetyFrame> parentFrame,
		    SemmetyFrame::FrameData&& child_a,
		    SemmetyFrame::FrameData&& child_b
		) {
		...
		bool operator==(const Parent& other) const { return children == other.children; }
	};
	...
	public:
		...
		bool operator==(const FrameData& other) const { return data == other.data; }
